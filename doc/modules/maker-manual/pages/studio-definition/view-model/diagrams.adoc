...
include::maker-manual:studio-definition/view-model/diagrams/diagram-description.adoc[leveloffset=+1]
include::maker-manual:studio-definition/view-model/diagrams/node-description.adoc[leveloffset=+1]
include::maker-manual:studio-definition/view-model/diagrams/edge-description.adoc[leveloffset=+1]
...
HINT: `Node Description` may have at most 1 `Node Palette`.
...
The behavior of this tool is specified through a xref:maker-manual:studio-definition/view-model.adoc#_model_operations[Model Operation].
